...
**Strona HTML partii (V13.4a / K16.1a / K17.1b / K20.1a / K20.1b / K21.1a / K22.1c / K22.2b / K23.1b / K23.2a / K23.3b / K24.1b):** `tbbui.gamepage.render_game_page(world,
...
`player_duchy_id` (K23.2a / K23.3b / K24.1b) — gdy równa się `duchy_id` wiersza,
ten element dostaje `data-player-duchy=""` i prefiks `» ` przed tekstem statusu,
a w osadzonych panelach osad i party wiersze z `owner_id == player_duchy_id`
dostają `data-player-owned=""`; `None` (domyślnie) → bajt-w-bajt jak bez argumentu;
