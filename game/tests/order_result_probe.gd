...
const EXPECTED_STATUS_TEXT := {
	...
	# G114.1c: powód przejściowy radzi czekanie; powód trwały nazywa stan BEZ rady
	# i BEZ odwołania do pustego spichlerza (na progu stanu pochłaniającego zapas
	# jest jeszcze dodatni). Nieznany powód → dotychczasowy tekst (nigdy puste).
