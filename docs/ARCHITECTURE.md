...
**Alert gospodarczy HTML (K60.1a / K60.1b / K61.1a / K61.1b / K61.2a / K61.2b):**
...
(`0` gdy `N==0`), widoczny tekst nagłówkowy spójny z tymi atrybutami: przy
`N==0` — `Osady na deficycie pszenicy: 0`; przy `N>0` —
`Osady na deficycie pszenicy: N (łączny deficyt: D pszenicy/mies.)` (sufiks
łącznego deficytu przed dziećmi wierszy), oraz po jednym dziecku
...
(bez `data-starving-settlements`, bez `data-total-wheat-deficit`, bez tekstu i
bez dzieci). Czyste, deterministyczne, bez mutacji `game`; rdzeń bez zmian.
Reużywa `tbbui.gamelookup.player_duchy`.
...
│       ├── economyalert.py # HTML alert gospodarczy: głodujące osady (K60.1a–b / K61.1a–b / K61.2a–b)
...
│   ├── test_economyalert.py # HTML alert gospodarczy (tbbui, K60.1a–b / K61.1a–b / K61.2a–b)
