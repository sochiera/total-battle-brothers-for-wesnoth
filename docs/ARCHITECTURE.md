...
**Alert gospodarczy HTML (K60.1a / K60.1b / K61.1a):**
...
│       ├── economyalert.py # HTML alert gospodarczy: głodujące osady (K60.1a–b / K61.1a)
...
│   ├── test_economyalert.py # HTML alert gospodarczy (tbbui, K60.1a–b / K61.1a)
