...
GAME = ROOT / "game"
PROBE = "res://tests/march_button_binding_probe.gd"
PREFIX = "MARCH_BUTTON_BINDING "


def test_march_button_is_a_single_safe_binding_and_renders_the_post_order_snapshot():
