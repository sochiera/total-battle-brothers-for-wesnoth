...
**Panel osad HTML (K22.1a–b / K23.3a / K25.2a–b / K26.1a–b / K27.2a / K55.1a–b / K56.1a–b):** `tbbui.settlementpanel.render_settlement_panel(world, player_duchy_id=None)
...
uzbrojenie: gotowe|wstrzymane (brak Kuźni)` (nawias z nazwami tylko gdy `B>0`;
...
`true` ↔ „gotowe", `false` ↔ „wstrzymane (brak Kuźni)").
