...
**Alert gospodarczy HTML (K60.1a / K60.1b / K61.1a / K61.1b):**
...
korzeń niesie `data-starving-settlements="N"`, gdzie `N` = liczba osad
`duchy.settlements` z `settlement.consumption.wheat > settlement.production.wheat`
(ściśle większe; bilans równy nie liczy się; inne księstwa ignorowane),
...
tbbui), `D = consumption.wheat - production.wheat` (dodatnie), a ciało wiersza
to widoczny tekst `<name>: deficyt D pszenicy/mies.` spójny z atrybutami
...
│       ├── economyalert.py # HTML alert gospodarczy: głodujące osady (K60.1a–b / K61.1a–b)
...
│   ├── test_economyalert.py # HTML alert gospodarczy (tbbui, K60.1a–b / K61.1a–b)
