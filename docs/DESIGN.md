...
(`Następna tura`/`Rekrutuj`/`Zbierz oddział`/`Rozbuduj osadę`). K29.2b
zlokalizował bare przyciski walki (`Marsz`/`Szturm`/`Starcie`) — spójnie z
polskimi nagłówkami sekcji i komunikatami; przyciski celów nadal pokazują
