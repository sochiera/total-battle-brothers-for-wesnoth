...
**Alert gospodarczy HTML (K60.1a / K60.1b / K61.1a / K61.1b / K61.2a):**
...
(`0` gdy `N==0`), widoczny tekst `Osady na deficycie pszenicy: N` spójny z
`data-starving-settlements` (bez widocznego łącznego deficytu — K61.2b), oraz
po jednym dziecku
...
│       ├── economyalert.py # HTML alert gospodarczy: głodujące osady (K60.1a–b / K61.1a–b / K61.2a)
...
│   ├── test_economyalert.py # HTML alert gospodarczy (tbbui, K60.1a–b / K61.1a–b / K61.2a)
