...
GAME = ROOT / "game"
PROBE = "res://tests/persistent_march_process_probe.gd"
PREFIX = "PERSISTENT_MARCH_PROCESS "
SEED = 73
...
def test_march_button_persists_changed_then_unchanged_across_two_godot_processes(tmp_path):
    state_path = tmp_path / "persistent-march-session.json"
    ...
    assert first["controls"]["order_status"] == "Rozkaz marszu zmienił stan."
    assert second["controls"]["order_status"] == "Rozkaz marszu nie zmienił stanu."
