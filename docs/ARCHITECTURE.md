...
**Panel osad HTML (K22.1a–b / K23.3a / K25.2a–b / K26.1a–b / K27.2a / K55.1a–b / K56.1a–b / K57.1a):** `tbbui.settlementpanel.render_settlement_panel(world, player_duchy_id=None)
...
bez `tick_economy`; zaraz po `data-equip-ready`, przed opcjonalnym
